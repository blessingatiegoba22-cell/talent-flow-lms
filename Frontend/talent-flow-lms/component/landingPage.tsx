        ...
        <div>
            <nav className="flex flex-row justify-between bg-[#07142F] p-8 text-[#FFFFFF] gap-x-24 align-center">
                ...
                <div className="flex flex-row justify-between gap-x-8">
                    <button className="bg-[#1F53C4] p-4 rounded-xl w-[187px]">Login</button>
                    <button className="border-4 border-[#FFFFFF] bg-transparent p-4 rounded-xl w-[187px]">Sign Up</button>
                </div>
            </nav>
            <div className="w-full h-full bg-[#133276] flex flex-row justify-between">
                <div className="p-16 w-1/3">
                    ...
                    <p>Talent Flow helps you discover the right courses, master in demands skills, and track your progress all in one seamless learning platform,</p>
                </div>
                <div className="p-16">
