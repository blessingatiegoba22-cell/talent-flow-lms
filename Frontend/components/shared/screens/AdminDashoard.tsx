...
import { Users, BookOpen, Activity, LayoutGrid } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 lg:p-10 bg-background min-h-screen">
      <header className="mb-10">
        <h1 className="text-display-xs font-bold text-foreground">Welcome back, Admin</h1>
        <p className="text-ink-300 mt-2 max-w-2xl">
          Everything is running smoothly and under your control. Let's get things moving 
          and keep the system at its best today.
        </p>
      </header>
