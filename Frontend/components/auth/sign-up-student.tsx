...
export function SignUpForm() {
  return (
    <div className="w-full max-w-5xl bg-[#020617] rounded-[2rem] p-6 sm:p-10 md:p-16 relative border border-slate-800 shadow-2xl min-h-fit lg:min-h-[750px] font-sans mx-auto">
      
      {/* 1. Return Icon - Responsive Positioning */}
      <Link 
        href="/" 
      ...
      {/* 2. Top Header (Logo & Category Badge) */}
        ...
        <div className="w-full max-w-[400px]">
          <form className="space-y-4">
            ...
            <div className="relative">
              ...
              <Input className="pl-12 bg-white text-black h-12 md:h-14 border-none rounded-xl font-medium" type="password" placeholder="Password" />
            </div>

            <div className="relative">
              <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500" size={20} />
              <Input className="pl-12 bg-white text-black h-12 md:h-14 border-none rounded-xl font-medium" type="password" placeholder="Confirm Password" />
            </div>
            ...
            <Button className="w-full bg-[#1D4ED8] hover:bg-blue-700 h-12 md:h-14 text-base font-bold rounded-xl transition-all active:scale-[0.98] shadow-lg">
              Sign Up
            </Button>
            ...
            >
              ...
              <span className="font-bold text-xs md:text-sm">Sign up with Google</span>
            </Button>
          </form>
        </div>
      </div>
