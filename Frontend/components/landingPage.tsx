...
import Primarybutton from "@components/reusbale/PrimaryButton";
import Secondarybutton from "@components/reusbale/SecondaryButton";
import Avatar from "@components/reusbale/Avartar";
